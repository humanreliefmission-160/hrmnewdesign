...
import { type SanityEcosystemStage, type SanityEcosystemStageNav } from "../../data/sanityTypes";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-brand-grey text-base max-w-lg mx-auto">
            Everything you need to know about the {stageName} stage, your impact, and how to get involved.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => {
            ...
            return (
              <div
                key={faq._key ?? i}
                className={`bg-brand-white rounded-sm border transition-all duration-200 ${
                  isOpen ? "border-purple shadow-sm" : "border-gray-200"
                }`}
              >
                <button
                ...
                >
                  <span
                    className={`font-semibold text-base pr-4 ${
                      isOpen ? "text-purple" : "text-brand-black"
                    }`}
                  >
                    {faq.question}
                  </span>
                  <div className="w-8 h-8 rounded-sm flex items-center justify-center shrink-0 bg-purple">
                    {isOpen ? (
                ...
                {isOpen && (
                  <div className="px-6 pb-5 border-t border-brand-lgrey">
                    <p className="text-brand-black/75 leading-relaxed text-sm pt-4">
                      {faq.answer}
                    </p>
                  </div>
                )}
